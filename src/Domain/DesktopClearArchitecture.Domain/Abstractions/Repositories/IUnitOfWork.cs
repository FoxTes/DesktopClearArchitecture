...
public interface IUnitOfWork : IDisposable
{
    ...
    /// <param name="sql">The raw SQL.</param>
    /// <param name="parameters">The parameters.</param>
    /// <returns>An <see cref="IQueryable{T}"/> that contains elements that satisfy
    /// the condition specified by raw SQL.</returns>
    ...
    /// Begin transaction.
    /// </summary>
    /// <param name="useIfExists">Use if exist.</param>
