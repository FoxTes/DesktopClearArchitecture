    ...
    where TEntity : class
{
    ...
    /// <returns>
    /// An <see cref="IPagedList{TEntity}"/> that contains elements that satisfy the condition
    ...
    /// </summary>
    /// <returns>
    /// The <see cref="IQueryable{TEntity}" />.
    /// </returns>
    /// <param name="disableTracking">
    /// <c>true</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.
    /// </param>
    ...
    /// <returns>
    /// An <see cref="IQueryable{TEntity}"/> that contains elements that satisfy the condition specified by raw SQL.
    /// </returns>
